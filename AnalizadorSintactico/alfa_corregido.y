...
declaraciones_funcion: declaraciones {fprintf(out, ";R28\t<declaraciones_funcion ::= <declaraciones>\n");}
					 | /*Vacio*/;
sentencias: sentencia {fprintf(out, ";R30\t<sentencias> ::= <sentencias>\n");}
...
condicional: TOK_IF TOK_PARENTESISIZQUIERDO exp TOK_PARENTESISDERECHO TOK_LLAVEIZQUIERDA sentencias TOK_LLAVEDERECHA
            ...
            | TOK_IF TOK_PARENTESISIZQUIERDO exp TOK_PARENTESISDERECHO TOK_LLAVEIZQUIERDA sentencias TOK_LLAVEDERECHA TOK_LLAVEIZQUIERDA TOK_ELSE TOK_LLAVEDERECHA
...
constante: constante_entera {fprintf(out, ";R99\t<constante> ::= <constante_entera\n");}
          | constante_logica {fprintf(out, ";R99\t<constante> ::= <constante_logica\n");};
